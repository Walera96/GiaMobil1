...
public enum UserRole {
    ...
    public String getPortal() {
        return switch (this) {
            ...
            case DEPARTMENT_HEAD, DEPARTMENT_SECRETARY -> "department";
    ...
    /**
     * Роли, имеющие доступ к порталу преподавателя (задания, проверка работ).
     */
    ...
    /**
     * Роли, имеющие доступ к порталу студента (задания, сдача работ).
     */
